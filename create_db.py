...
#engine = create_engine("mysql+mysqlconnector://root:root@dbb/database")
...
corpus_to_db(sources_train_test[0],'sources_train')
# add test dataset to db
corpus_to_db(sources_train_test[1],'sources_test')
